...
; atkinson dithering pattern - spreads error to 6 neighboring pixels
(define dither-pattern
  (list
    (dither-pixel 0 1 1/8)
    (dither-pixel 0 2 1/8)
    (dither-pixel 1 -1 1/8)
    (dither-pixel 1 0 1/8)
    (dither-pixel 1 1 1/8)
    (dither-pixel 2 0 1/8)))
...
(send bmp save-file "atkinson.bmp" 'bmp 100)